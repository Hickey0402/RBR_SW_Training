 ...
 * 
 * secret function takes in three parameters: two integers and one boolean
 * It returns true if either the first integer is greater than the second integer OR the boolean is true
